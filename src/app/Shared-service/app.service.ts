...
import {Iitem, Idescrition, Imeta, Iurl, Ievents} from './item.model';
...
export class ItemService {
  ...
  private valuefooter: BehaviorSubject < string > = new BehaviorSubject < string > (null);
...
public setValue1(value: string): void {
  this.valuefooter.next(value);
}

public getValue1(): Observable < string > {
  return this.valuefooter;
}
public getWishValue(): Observable < string > {
  return this.valueObs;
}
// no longer using static data from var EVENTS
getEvents()  {
...
const EVENTS: Ievents[] = [
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 950.00,
    imageUrl: '../assets/mage/ng-nl.png',
    location: {
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 759.00,
    imageUrl: '../assets/Image/ng-conf.png',
    location: {
